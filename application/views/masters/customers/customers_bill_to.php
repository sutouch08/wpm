...
<form class="form-horizontal" id="billToForm" method="post" action="<?php echo $action; ?>">
    ...
    <label class="col-sm-2 control-label no-padding-right">Branch Code</label>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label no-padding-right">Branch Name</label>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label no-padding-right">Sub District</label>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label no-padding-right">District</label>
    <div class="col-xs-12 col-sm-4">
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label no-padding-right">Province</label>
    <div class="col-xs-12 col-sm-4">
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label no-padding-right">Post code</label>
    <div class="col-xs-6 col-sm-1 col-1-harf">
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label no-padding-right">Country Code</label>
