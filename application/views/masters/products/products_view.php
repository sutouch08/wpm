...
<div class="row">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5">
  	<p class="pull-right top-p">
			<button type="button" class="btn btn-sm btn-info btn-100" onclick="export_filter()"><i class="fa fa-file-excel-o"></i> Export</button>
    <?php if($this->pm->can_add) : ?>
      <button type="button" class="btn btn-sm btn-success btn-100" onclick="addNew()"><i class="fa fa-plus"></i> Add New</button>
    <?php endif; ?>
    </p>
  </div>
</div><!-- End Row -->
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
		<table class="table table-striped table-bordered table-hover" style="min-width:1050px;">
			<thead>
				<tr style="font-size:11px;">
					<th class="fix-width-100"></th>
					<th class="fix-width-50 middle text-center">#</th>
					<th class="fix-width-50 middle text-center">Active</th>
					<th class="fix-width-50 middle text-center">Img</th>
					<th class="fix-width-150 middle text-center">Code</th>
					<th class="min-width-150 middle text-center">Description</th>
					...
					<th class="fix-width-100 middle text-center">Kind</th>
					<th class="fix-width-50 middle text-center">Year</th>
					<th class="fix-width-50 middle text-center">Sell</th>
				</tr>
			</thead>
			<tbody>
			<?php if(!empty($data)) : ?>
				...
				<?php foreach($data as $rs) : ?>
					<tr style="font-size:11px;" id="row-<?php echo $rs->code; ?>">
						<td class="middle">
							<button type="button" class="btn btn-minier btn-info" onclick="doExport('<?php echo $rs->code; ?>')">
