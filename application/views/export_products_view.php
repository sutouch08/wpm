...
<div class="row">
  ...
  <div class="col-sm-6">
    <p class="pull-right top-p">
      <button type="button" class="btn btn-sm btn-primary" id="btn-sync" onclick="syncData()"><i class="fa fa-retweet"></i> Export Items</button>
...
<script>
  var items_date = '<?php echo $items_date; ?>';
</script>
<script src="<?php echo base_url(); ?>scripts/export_products.js"></script>
