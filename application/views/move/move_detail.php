<div class="row">
    ...
    <form id="productForm">
    	<table class="table table-striped table-bordered">
        	...
        	<tr>
              ...
              <div class="col-sm-6">
                <p class="pull-right top-p">
                  <button type="button" class="btn btn-sm btn-primary" onclick="addToMove()">Move Selected</button>
                </p>
              </div>
            </th>
          </tr>
          ...
          <tr>
            ...
            <th class="width-40 text-center">Items</th>
            <th class="width-10 text-center">In Loc.</th>
            <th class="width-10 text-center">Move Out</th>
          </tr>
          </thead>
	...
	<div class="col-sm-12" id="move-table">
  	<table class="table table-striped border-1">
    	<thead>
      	<tr>
        	<th colspan="7" class="text-center">Moved Items</th>
        </tr>
...
<?php	else : ?>
 				<tr>
        	<td colspan="7" class="text-center"><h4>No items found</h4></td>
        </tr>
<?php	endif; ?>
      </tbody>
    </table>
...
{{#each this}}
	{{#if nodata}}
	<tr>
		<td colspan="7" class="text-center"><h4>No items moved</h4></td>
	</tr>
	{{else}}
		{{#if @last}}
			<tr>
