...
<script>
	function process(fileName) {
		load_in();
		$.ajax({
			url:BASE_URL + "rest/V1/agx_transfer_confirm/process_confirm/",
			type:'POST',
			cache:false,
			data:{
				'fileName' : fileName
	...
	function viewDetail(fileName) {
		...
		$.ajax({
			url:BASE_URL + "rest/V1/agx_transfer_confirm/get_detail",
			type:'POST',
			cache:false,
			data:{
				'fileName' : fileName
	...
	function doDelete(fileName, no){
		$.ajax({
			url:BASE_URL + "rest/V1/agx_transfer_confirm/delete",
			type:'POST',
			cache:false,
			data:{
				'fileName' : fileName
