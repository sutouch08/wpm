...
<form class="hidden-print" id="reportForm" method="post" action="<?php echo $this->home; ?>/do_export">
	<div class="row">
	  ...
	  <div class="col-lg-2 col-md-2 col-sm-2-harf col-xs-6 padding-5 ">
			<label class="display-block">Loaction</label>
	    <div class="btn-group width-100" style="height:30px;">
...
<script id="template" type="text/x-handlebars-template">
  <table class="table table-bordered table-striped">
    <tr>
      <th colspan="6" class="text-center">Report on consignment inventories as of {{ reportDate }}</th>
    </tr>
    <tr>
...
<script src="<?php echo base_url(); ?>scripts/report/inventory/consign_stock_zone.js"></script>
