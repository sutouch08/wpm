  ...
  <div class="col-lg-2 col-md-2 col-sm-2-harf col-xs-6 padding-5">
	...
	<div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
		...
		<select class="form-control input-sm" name="isValid" onchange="getSearch()">
			<option value="all">All</option>
			<option value="0" <?php echo is_selected($isValid, "0"); ?>>Pending</option>
			<option value="1" <?php echo is_selected($isValid, "1"); ?>>Confirmed</option>
		</select>
	</div>
	<?php endif; ?>
	...
	<div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-6 padding-5">
		...
		<select class="form-control input-sm" name="sap_status" onchange="getSearch()">
			...
			<option value="1" <?php echo is_selected('1', $sap_status); ?>>In temp</option>
		...
		<table class="table table-striped border-1" style="min-width:1020px;">
			<thead>
				<tr>
					...
					<th class="fix-width-250 middle">Customer</th>
					<th class="fix-width-250 middle">Bin Location</th>
					<th class="fix-width-100 middle">Amount</th>
					<th class="fix-width-100 middle">Status</th>
					<th class="fix-width-60 middle">Approval</th>
				</tr>
			</thead>
			<tbody>
        <?php if(!empty($orders)) : ?>
