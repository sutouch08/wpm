...
<div class="tab-pane fade" id="customer">
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <h4 class="title">Set conditions according to customer qualifications.</h4>
    </div>
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <span class="form-control left-label text-right">Specify</span>
    </div>
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <div class="btn-group width-100">
    ...
    <div class="col-lg-1 col-md-1 col-sm-1-harf col-xs-3 padding-5">
      <button type="button" class="option btn btn-xs btn-info btn-block" id="btn-cust-id-add" onclick="addCustId()" disabled><i class="fa fa-plus"></i> Add</button>
    </div>
    <div class="divider-hidden visible-xs"></div>
    <div class="col-xs-4 visible-xs">&nbsp;</div>
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-5 padding-5">
      <span class="form-control input-sm text-center"><span id="count"><?php echo $cusListNo; ?></span> items</span>
    </div>
    <div class="col-lg-1 col-md-1 col-sm-1-harf col-xs-3 padding-5">
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <button type="button" class="option btn btn-xs btn-info btn-block padding-right-5" id="btn-select-cust-group" onclick="showCustomerGroup()" disabled>
        Select <span class="badge pull-right" id="badge-group"><?php echo $custGroupNo; ?></span>
      </button>
    </div>
    <div class="divider-hidden"></div>
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <button type="button" class="option btn btn-xs btn-info btn-block padding-right-5" id="btn-select-cust-type" onclick="showCustomerType()" disabled>
        Select <span class="badge pull-right" id="badge-type"><?php echo $custTypeNo; ?></span>
      </button>
    </div>
    <div class="divider-hidden"></div>
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <button type="button" class="option btn btn-xs btn-info btn-block padding-right-5" id="btn-select-cust-kind" onclick="showCustomerKind()" disabled>
        Select <span class="badge pull-right" id="badge-kind"><?php echo $custKindNo; ?></span>
      </button>
    </div>
    <div class="divider-hidden"></div>
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <button type="button" class="option btn btn-xs btn-info btn-block padding-right-5" id="btn-select-cust-area" onclick="showCustomerArea()" disabled>
        Select <span class="badge pull-right" id="badge-area"><?php echo $custAreaNo; ?></span>
      </button>
    </div>
    <div class="divider-hidden"></div>
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <button type="button" class="option btn btn-xs btn-info btn-block padding-right-5" id="btn-select-cust-class" onclick="showCustomerClass()" disabled>
        Select <span class="badge pull-right" id="badge-class"><?php echo $custClassNo; ?></span>
      </button>
    </div>
    <div class="divider-hidden"></div>
    <div class="divider-hidden"></div>
    ...
    <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-4 padding-5">
      <button type="button" class="btn btn-xs btn-success btn-block" onclick="saveCustomer()"><i class="fa fa-save"></i> Save</button>
    </div>
