...
$this->xprinter->add_title('ใบส่งคืนสินค้า(RN)');
...
$header['right']['A'] = array(
    ...
    array('label' => 'อ้างอิง', 'value' => $order->lend_code)
);

$header['right']['B'] = array(
	array('label' => 'คลังปลายทาง', 'value' => $order->to_warehouse_name),
	array('label' => 'ผู้ยืม', 'value' => $order->empName),
