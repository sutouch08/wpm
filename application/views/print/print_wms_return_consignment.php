...
$this->xprinter->add_title('ใบส่งคืนสินค้า(CN)');
...
while($total_page > 0 )
{
  ...
  $page .= $this->xprinter->table_start();
	...
	{
		$page .= '
		<div style="width:200px; height:100px; position:relative; left:10%; line-height:0px; top:300px;color:red; text-align:center; z-index:100000; opacity:0.1; transform:rotate(-30deg)">
