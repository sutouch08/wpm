...
<div class="row">
  ...
  <div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-4 padding-5">
	...
	<div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-4 padding-5">
		...
		<input type="text" class="form-control input-sm text-center" name="customerCode" id="customerCode" value="" placeholder="customer code" required />
	</div>
  <div class="col-lg-4 col-md-5 col-sm-6-harf col-xs-6 padding-5">
    <label class="not-show">ชื่อผู้เบิก[ใช้งบ]</label>
    <input type="text" class="form-control input-sm" name="customer" id="customer" value="" placeholder="customer name" required />
  </div>
    ...
    <input type="text" class="form-control input-sm" name="empName" id="empName" value="" placeholder="employee name" required />
  </div>
