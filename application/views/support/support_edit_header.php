<div class="row">
    ...
    <div class="col-lg-1-harf col-md-1-harf col-sm-1-harf col-xs-4 padding-5">
		...
		<div class="col-lg-1-harf col-md-2 col-sm-2 col-xs-4 padding-5">
			...
			<input type="text" class="form-control input-sm text-center edit" name="customerCode" id="customerCode" placeholder="customer code" value="<?php echo $order->customer_code; ?>" disabled />
		</div>
    <div class="col-lg-7-harf col-md-6-harf col-sm-6-harf col-xs-12 padding-5">
    	<label class="not-show">ผู้เบิก</label>
			<input type="text" class="form-control input-sm edit" id="customer" name="customer" placeholder="customer name" value="<?php echo $order->customer_name; ?>" disabled />
    </div>
