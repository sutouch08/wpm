...
<div class="tab-pane fade" id="company">
	<form id="companyForm" method="post" action="<?php echo $this->home; ?>/update_config">
  	<div class="row">
    	<div class="col-sm-3">
        <span class="form-control left-label">Company Name</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Company Full Name</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Address 1</span>
      </div>
      <div class="col-sm-5">
      ...
      <div class="divider-hidden"></div>
			...
			<div class="col-sm-3">
        <span class="form-control left-label">Address 2</span>
      </div>
      <div class="col-sm-5">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Zip Code</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Phone</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Fax</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Email</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Tax ID</span>
      </div>
      <div class="col-sm-9">
      ...
      <div class="col-sm-3">
        <span class="form-control left-label">Start Year (A.D.)</span>
      </div>
      <div class="col-sm-9">
