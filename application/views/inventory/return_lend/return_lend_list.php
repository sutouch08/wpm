  ...
  <div class="row">
    ...
    <div class="col-lg-1-harf col-md-1-harf col-sm-2 col-xs-6 padding-5">
      ...
      <select class="form-control input-sm" name="must_accept" onchange="getSearch()">
        ...
        <option value="0" <?php echo is_selected('0', $must_accept); ?>>No need to acept</option>
      </select>
    </div>
    ...
    <table class="table table-striped border-1" style="min-width:1200px;">
      <thead>
        <tr>
          ...
          <th class="fix-width-120">Lend No.</th>
          ...
          <th class="fix-width-200">Lender</th>
          <th class="min-width-100">Operator</th>
        </tr>
      </thead>
      <tbody>
<?php if(!empty($docs)) : ?>
