...
<?php if($manual_code == 1) :?>
	...
	<input type="hidden" id="prefix" value="<?php echo getConfig('PREFIX_ADJUST_CONSIGNMENT'); ?>">
	<input type="hidden" id="runNo" value="<?php echo getConfig('RUN_DIGIT_ADJUST_CONSIGNMENT'); ?>">
<?php endif; ?>
<div class="row">
	<div class="col-sm-6">
    	<h3 class="title" >
